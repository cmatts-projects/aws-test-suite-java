...
import awsv2.repackaged.software.amazon.payloadoffloading.PayloadS3Pointer;
import awsv2.repackaged.software.amazon.payloadoffloading.PayloadStore;
...
import awsv2.repackaged.software.amazon.payloadoffloading.Util;
 ...
 * </ul>
 */
public class AmazonSQSExtendedClient extends awsv2.repackaged.com.amazon.sqs.javamessaging.AmazonSQSExtendedClientBase implements SqsClient {
    ...
    static final List<String> RESERVED_ATTRIBUTE_NAMES = Arrays.asList(LEGACY_RESERVED_ATTRIBUTE_NAME,
            awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.RESERVED_ATTRIBUTE_NAME);
    private awsv2.repackaged.com.amazon.sqs.javamessaging.ExtendedClientConfiguration clientConfiguration;
    ...
    public AmazonSQSExtendedClient(SqsClient sqsClient) {
        this(sqsClient, new awsv2.repackaged.com.amazon.sqs.javamessaging.ExtendedClientConfiguration());
    }
     ...
     */
    public AmazonSQSExtendedClient(SqsClient sqsClient, awsv2.repackaged.com.amazon.sqs.javamessaging.ExtendedClientConfiguration extendedClientConfig) {
        super(sqsClient);
    ...
    private void checkMessageAttributes(Map<String, MessageAttributeValue> messageAttributes) {
        ...
        if (messageAttributesNum > awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.MAX_ALLOWED_ATTRIBUTES) {
            String errorMessage = "Number of message attributes [" + messageAttributesNum
                    ...
                    + awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.MAX_ALLOWED_ATTRIBUTES + "].";
            LOG.error(errorMessage);
            throw SdkClientException.create(errorMessage);
        }
    ...
    private String embedS3PointerInReceiptHandle(String receiptHandle, String pointer) {
        ...
        String modifiedReceiptHandle = awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.S3_BUCKET_NAME_MARKER + s3MsgBucketName
                + awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.S3_BUCKET_NAME_MARKER + awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.S3_KEY_MARKER
                + s3MsgKey + awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.S3_KEY_MARKER + receiptHandle;
        return modifiedReceiptHandle;
    }

    private String getOrigReceiptHandle(String receiptHandle) {
        int secondOccurence = receiptHandle.indexOf(awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.S3_KEY_MARKER,
                receiptHandle.indexOf(awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.S3_KEY_MARKER) + 1);
        return receiptHandle.substring(secondOccurence + awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.S3_KEY_MARKER.length());
    }
    ...
    private boolean isS3ReceiptHandle(String receiptHandle) {
        return receiptHandle.contains(awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.S3_BUCKET_NAME_MARKER)
                && receiptHandle.contains(awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.S3_KEY_MARKER);
    }

    private String getMessagePointerFromModifiedReceiptHandle(String receiptHandle) {
        String s3MsgBucketName = getFromReceiptHandleByMarker(receiptHandle, awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.S3_BUCKET_NAME_MARKER);
        String s3MsgKey = getFromReceiptHandleByMarker(receiptHandle, awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.S3_KEY_MARKER);
    ...
    private Optional<String> getReservedAttributeNameIfPresent(Map<String, MessageAttributeValue> msgAttributes) {
        ...
        if (msgAttributes.containsKey(awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.RESERVED_ATTRIBUTE_NAME)) {
            reservedAttributeName = awsv2.repackaged.com.amazon.sqs.javamessaging.SQSExtendedClientConstants.RESERVED_ATTRIBUTE_NAME;
